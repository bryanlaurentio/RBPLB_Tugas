    ...
    <div class="container py-5">
        <div class="row text-center py-3">
            <div class="col-lg-6 m-auto">
                ...
                <div>
                    Anda telah memilih paket A bulan dengan durasi 30 hari dengan total pembayaran sebesar Rp100.000,- 
                </div>
                <p>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <p href="#" class="h2 text-center text-dark">BRI</p>
                            ...
                            <p class="text-center"><a class="btn btn-success" href="{{ route('bria')}}">Bayar</a></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-5 mb-4 center">
                <div class="card h-100">
                    <div class="card-body">
                        <p href="#" class="h2 text-center text-dark">BCA</p>
                            ...
                            <p class="text-center"><a class="btn btn-success" href="{{ route('bcaa')}}">Bayar</a></p>
                    </div>
                </div>
            </div>
    </div>
