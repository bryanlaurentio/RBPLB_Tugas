                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('bcab') }}">BCA</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{ route('checkoutb') }}" class="btn btn-sm btn-neutral">Kembali</a>
                </div>
            </div>
        </div>
    </div>
...
{{-- content --}}
            ...
            <p class="text-center">Pastikan kamu telah melakukan pembayaran di ke BCA VA: 1000000003!</p>
            <p class="text-center">Tagihan : Rp500.000,-</p>
            <br>
